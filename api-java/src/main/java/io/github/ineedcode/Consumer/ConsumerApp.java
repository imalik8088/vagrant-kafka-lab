...
public class ConsumerApp {
    public static void main(String[] args){
        ...
        props.put("group.id", "java-consumer-app");
        ...
        partitions.add(new TopicPartition("akhlaq", 0)); // Adds a TopicPartition instance representing a topic and a partition.
        partitions.add(new TopicPartition("akhlaq", 1)); // Adds a TopicPartition instance representing a topic and a partition.
        partitions.add(new TopicPartition("akhlaq", 2)); // Adds an additional TopicPartition instance representing a different partition within the topic. Change as desired.
