...
public class ConsumerPartitionApp {
   public static void main(String[] args) {
      ...
      props.put("group.id", "java-simple-producer-consumer");
...
//        props.put("client.id", "java-consumer-app");


      // Create a KafkaConsumer instance and configure it with properties.
      KafkaConsumer<String, String> myConsumer = new KafkaConsumer<String, String>(props);

      myConsumer.subscribe(Arrays.asList("simple-producer-consumer"));

      // Create a topic subscription list:
      ArrayList<TopicPartition> partitions = new ArrayList<TopicPartition>();
      partitions.add(new TopicPartition("simple-producer-consumer", 0)); // Adds a TopicPartition instance representing a topic and a partition.
      partitions.add(new TopicPartition("simple-producer-consumer", 1)); // Adds a TopicPartition instance representing a topic and a partition.
      partitions.add(new TopicPartition("simple-producer-consumer", 2)); // Adds an additional TopicPartition instance representing a different partition within the topic. Change as desired.
